<div class="stimulate">
    ...
    <img alt="big-burger" class="big-burger" src="images/juicy-burger.jpeg">
</div>
...
<div class="time">
    <div class="work-hours">
        <img alt="timer" src="images/clock.png" class="timer">
    ...
    <div class="visit-us">
        <img alt="meeting-point" src="images/meeting-point.png" class="meet-point">
        <p>Відвідай нас з</p>
...
<div>
    ...
    <div class="mini-menu">
        <div class="mini-position">
            <img src="images/1.png" alt="burger1" class="burger-pic">
        ...
        <div class="mini-position">
            <img src="images/2.png" alt="burger1" class="burger-pic">
        ...
        <div id="extra" class="mini-position">
            <img src="images/3.png" alt="burger1" class="burger-pic">
        ...
        <div class="mini-position">
            ...
            <a href="index.php?page=menu" class="more-in-menu">БIЛЬШЕ У<br>МЕНЮ→</a>
        </div>
    </div>
